...
<ResponseField name="exchangeRateId" type="string" required>
  The ID of the exchange rate used for this conversion. To lock a rate for Authorize Transfer, use the `exchangeRateId` returned by [Fetch Exchange Rates](/docs/products/global-payout/fetch-exchange-rates).
</ResponseField>
