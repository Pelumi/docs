...
<ParamField body="lockedExchangeRateId" type="string">
  Optional exchange rate ID from [Fetch Exchange Rates](/docs/products/global-payout/fetch-exchange-rates). Use this to lock the quoted rate before authorizing.
</ParamField>
