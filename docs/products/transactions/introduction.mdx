...
<CardGroup cols={2}>
  <Card
    ...
    href="/docs/products/transactions/fetch-transactions#fetch-account-transactions"
  >
  ...
  <Card
    ...
    href="/docs/products/transactions/fetch-transactions#fetch-bank-transactions"
  >
  ...
  <Card
    ...
    icon="wallet"
    href="/docs/products/transactions/fetch-transactions#fetch-virtual-account-transactions"
  >
  ...
  <Card
    ...
    icon="searchengin"
    href="/docs/products/transactions/fetch-transactions#transaction-requery"
  >
