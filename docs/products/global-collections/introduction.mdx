---
title: 'Overview'
description: 'Learn how to collect funds from customers across supported mobile money networks with the Nomba Global Collections API'
---

GlobalCollections simplifies the process of receiving funds, giving you reliable tools to collect money from customers across supported mobile money networks. Whether you're triggering a payment prompt or checking the outcome of a collection, GlobalCollections keeps your inflow operations running smoothly.
