...
If you want a hosted payment experience instead of a direct collection API, use [Checkout](/docs/products/accept-payment/checkout-overview). Checkout supports DRC payment experiences such as Mobile Money, and supported DRC USD flows can also surface Apple Pay and International Card.
