...
description: 'Accept card and bank transfer payments from your customers using Nomba Checkout'
---
...
<Steps>
  <Step title="Get your API keys">
    Create an account and retrieve your `clientId` and `clientSecret` from the [Nomba dashboard](https://dashboard.nomba.com). Both sandbox and production credentials are issued when you create an API key.
  </Step>
