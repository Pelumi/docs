...
This is the easiest way to debug webhooks. You can view webhook logs, inspect responses from your server, monitor delivery attempts and even repush an event directly from the dashboard.

- Navigate to **Developer** → **Webhook Repush**.  

<Frame caption="Webhook repush">
  <img src="/images/Webhook-repush.png" style={{ borderRadius: '0.5rem' }} loading="lazy" />
</Frame>
