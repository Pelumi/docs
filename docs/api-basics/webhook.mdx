...
```json expandable Payout Success
{
    ...
    "requestId": "69c9aebe-a4e6-4144-8248-bXXXXXXXX",
    "data": {
        "merchant": {
            "walletId": "67a4e03745f1a049XXXXXX",
            "walletBalance": 1000,
            "userId": "8yanljbsXXXXX"
        },
        "terminal": {},
        "transaction": {
            "fee": 7,
            "type": "transfer",
            "transactionId": "API-TRANSFER-8A07F-d945b6f5-903c-4a5a-84bb-XXXXXXXX",
            "responseCode": "",
            "originatingFrom": "api",
            "merchantTxRef": "EG17IJXXXX",
            "transactionAmount": 370,
            "narration": "From David O",
            "time": "2025-10-11T21:25:42Z"
        },
        "customer": {
            "bankCode": "305",
            "senderName": "Faruk ",
            "recipientName": "FARUK OSENI JOSEPH"
            "bankName": "Paycom (Opay)",
            "accountNumber": "9133647309"
        }
    }
}
```
            ...
            try {
                String payload = """
                    ...
                    "data": {
                        ...
                        "aliasAccountNumber": "5343270516",
                        "fee": 5,
                        "sessionId": "IFAP-TRANSFER-46501-***-1a2f-4b43-9bd5-fec9649e5928",
                        "type": "vact_transfer",
                        "transactionId": "API-VACT_TRA-B7B10-0435b274-807a-4bc7-8abe-9dbb4548fd7a",
                        "aliasAccountName": "SAMPLE/JOHN DOE",
                        "responseCode": "",
        ...
        public class HooksCron
        {
            public static void Main()
            {
                try
                {
                    ...
                    var secret = "HkatexKDZg7CLWy96q5sfrVHSvtoz92B";
        ...
        function hooksCron2() {
            try {
                ...
                "data": {
                    ...
                    "time": "2025-09-29T10:51:44Z",
                    "aliasAccountReference": "654f7c80b****510c90fb7f92",
                    "aliasAccountType": "VIRTUAL"
                    },
                    "customer": {
                    "bankCode": "090645",
