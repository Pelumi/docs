...
<CardGroup cols={2}>
  <Card
    ...
    icon="money-bill"
    href="/docs/products/accept-payment/overview"
  >
  ...
  <Card
    title="Transfer"
    icon="shuffle"
    href="/docs/products/transfers/introduction"
  >
  ...
  <Card
    title="Terminals"
    icon="mobile-retro"
    href="/docs/products/terminals/custom-apps/introduction"
  >
...
<CardGroup cols={2}>
  <Card
    title="Try the API — no account needed"
    icon="bolt"
    href="/docs/guides/try-the-api"
  >
