...
<Steps>
  ...
  <Step title="Create a checkout order">
    ...
    ```json Response
    {
        ...
        "description": "Success",
        "data": {
            "checkoutLink": "https://checkout.nomba.com/pay/fd3002af-d48b-40a0-adba-0b1e2f3a4b5c",
            "orderReference": "fd3002af-d48b-40a0-adba-0b1e2f3a4b5c"
        }
    }
    ```
    ...
    <Note>
      The `orderReference` in the response is the Nomba-generated order ID, not the reference you passed in the request. See [Create Checkout Order](/docs/products/accept-payment/create-checkout-order#request-fields) for how the two values are used.
    </Note>
