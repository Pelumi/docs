...
<Note> 
  Transaction APIs are paginated. We recommend reviewing the [pagination guide](/v2/api-basics/pagination) to understand how to work with paginated endpoints or trying out live API interactions to see how it works in practice. 
</Note>
...
To learn how Nomba handles pagination, [check here.](/v2/api-basics/pagination)
