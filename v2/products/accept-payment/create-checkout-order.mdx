...
Besides these mandatory fields when creating a checkout order, there are various optional fields that can be used for a number of customizations while creating a checkout order; they can be seen in the request body.
...
Follow the request and sample response code shown below to create a checkout order.
