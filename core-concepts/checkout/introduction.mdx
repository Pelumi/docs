...
<CardGroup cols={3}>
  <Card
    ...
    icon="money-bill"
    href="/core-concepts/checkout/create-checkout-order"
  >
  ...
  <Card
    ...
    icon="credit-card"
    href="/core-concepts/checkout/charge-tokenized-cards"
  >
    Learn how to charge already tokenized cards
  </Card>
  <Card
    title="Manage disputes"
    icon="comment-dollar"
    href="/core-concepts/checkout/dispute-management"
  >
...
<Frame caption="Nomba Checkout flow">
    <img src="/images/checkout-1.png" style={{ borderRadius: '0.5rem' }} />
</Frame>
...
<Steps titleSize="p">
  <Step title="Pay with Card">
    ...
    <Frame caption="Pay with card">
      <img src="/images/pay-with-card-1.png" style={{ borderRadius: '0.5rem' }} />
    </Frame>
  ...
  <Step title="Pay with Bank Transfer">
    ...
    <Frame caption="Pay with bank transfer">
      <img src="/images/pay-with-bank-transfer-1.png" style={{ borderRadius: '0.5rem' }} />
    </Frame>
  </Step>
</Steps>
