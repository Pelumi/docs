...
<CardGroup cols={2}>
  <Card
    title="Assign terminals to the parent account"
    icon="paperclip"
    href="/nomba-api-reference/terminals/assign-a-terminal-to-the-parent-account"
  >
  </Card>
  <Card
    title="Assign terminals to sub accounts"
    icon="paperclip"
    href="/nomba-api-reference/terminals/assign-a-terminal-to-an-account"
  >
  </Card>
</CardGroup>
