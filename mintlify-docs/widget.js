(function () {
  ...
  var backendMap = {
    ...
    'developer.nomba.com':          'https://mintlify-docs.kudi.ai',
    'nomba-90.mintlify.app': 'https://mintlify-docs.kudi.ai'
  };
  var BACKEND = backendMap[window.location.hostname] || 'https://mintlify-docs.kudi.ai';
