---
title: 'Filtering through transactions'
description: 'Learn how to filter through transactions on an account.'
---
...
<CardGroup cols={2}>
  ...
  <Card
    title="Filter sub account transactions"
    icon="receipt"
    href="/nomba-api-reference/transactions/filter-sub-account-transactions"
  >
  </Card>
</CardGroup>
