...
<CardGroup cols={2}>
  <Card
    ...
    icon="link-simple"
    href="/nomba-api-reference/airtime-and-data/vend-airtime-via-parent-account"
  ></Card>
  <Card
    title="Vend airtime via a subaccount"
    icon="link-simple"
    href="/nomba-api-reference/airtime-and-data/vend-airtime-via-specific-account"
  ></Card>
</CardGroup>
