...
### February 2026
- **Webhooks** `docs` – Introduced support for replaying webhook events. See updates in [Debug webhooks](/docs/api-basics/troubleshoot-webhooks).

- **Transfer V2** `added` – Improved the documentation with clearer explanations of transfer status values.
