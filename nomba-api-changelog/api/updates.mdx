...
### July 2025
• **Fetch parent account details** `added` – We have added documentation for retrieving parent account details, click here to learn more about it. [View Virtual account lookup](/products/accounts/fetch-parent-account-details).
