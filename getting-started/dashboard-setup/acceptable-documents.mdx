...
description: 'Learn the documents needed for KYC verification'
---

To comply with local regulations, we require specific documents. These documents are necessary for Know Your Customer (KYC) verification purposes and help ensure the legitimacy of your business. 
...
This includes various CAC forms, such as:
...
These documents provide a status update or profile of a company, indicating that it is properly registered with the CAC.
...
5. BVN of ALL Directors (1 of each at onboarding)
6. NIN ( Enter the values, not upload) or Valid ID of Director
